...
class OmnibarController: NSViewController {
    ...
    override func loadView() {
        ...
        omnibar.omnibarDelegate = self
        self.view = omnibar
    }
}

extension OmnibarController: @preconcurrency SelectsWord {
    func select(word: Word) {
        omnibar.display(content: .selection(text: word))
    }
}

extension OmnibarController: @preconcurrency DisplaysSuggestion {
...
extension OmnibarController: @preconcurrency OmnibarDelegate {
